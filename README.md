...
| **photoelectric effect** | [Photoelectric-effect.md](photoelectric-effect/Photoelectric-effect.md) | text-only, DIAGRAM briefs | in progress | 36-question, 3 h, 200-mark INPhO-standard paper | 🚧 in progress — plan.md PART 23 |
| **atomic structure** | [Atomic-structure.md](atomic-structure/Atomic-structure.md) | text-only, DIAGRAM briefs | in progress | 36-question, 3 h, 200-mark INPhO-standard paper | 🚧 in progress — plan.md PART 24 |
| **x-rays** | [X-rays.md](x-rays/X-rays.md) | text-only, DIAGRAM briefs | in progress | 36-question, 3 h, 200-mark INPhO-standard paper | 🚧 in progress — plan.md PART 25 |
